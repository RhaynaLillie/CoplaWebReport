...
* Prior to European colonization, the most dominant vegetation system for the Wyoming Sagebrush Subregion was [Colorado Plateau Pinyon-Juniper Woodland](https://landfirereview.org/search.php?q=Colorado%20Plateau%20Pinyon-Juniper%20Woodland&hPP=20&idx=lf_landfire_dev&p=0&is_v=1){target="blank"}.
* This system experienced ~58,000 acres of fire annually across the subregion historically.
* The Rocky Mountain Montane Riparian Systems had the most disturbance annually with substantial amounts of 'wind/weather/stress' (i.e., flooding in this system).
...
bpsChart <- 
  ...
  labs(
    ...
    caption = "Data from landfire.gov; Chart © Rhayna Lillie",
    x = "",
