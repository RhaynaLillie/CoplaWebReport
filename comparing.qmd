...
* LANDFIRE mapped a fair amount of change in the "Past Conifer" class, with almost 30% of it being mapped as shrubland on the landscape today.
* Almost all of today's exotic vegetation was mapped on former shrubland areas. 
...
- Rocky Mountain Montane Riparian Systems have the difference between the reference and current amounts of succession classes, with a substantial over representation of succession class B.
